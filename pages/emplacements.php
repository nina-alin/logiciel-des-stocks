...
<ul class="dropdown-menu dropdown-user">
    ...
    <li class="active"><a href="../pages/emplacements.php"><i class="fas fa-warehouse"></i>&nbsp;Emplacements</a></li>
...
<div id="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <br /><br />
            <div class="col-1">
                <button class="btn btn-warning" data-target="#myModalEmplacementsAdd" data-toggle="modal" title="Ajouter">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr templacementsPK="<?php echo $row["templacementsPK"]; ?>">
                                    ...
                                    <td>
                                        <button class="update btn btn-primary" data-target="#myModalEmplacementsUpdate" data-toggle="modal" data-id="<?php echo $row["templacementsPK"]; ?>" data-nom="<?php echo $row["nomEmplacement"]; ?>" title="Modifier">
                                            <i class="fas fa-pen"></i>
                                        </button>&nbsp;
                                        <button class="delete btn btn-danger" data-target="#myModalEmplacementsDelete" data-toggle="modal" data-id="<?php echo $row["templacementsPK"]; ?>" title="Supprimer">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                        <form id="templacements_form">
                            <tr>
                                <th>Nom</th>
                                <td>
                                    <input class="form-control" id="nomEmplacement" name="nomEmplacement" size="40px" required><b></b>
                                </td>
                            </tr>
                        </form>
                    </table>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                            <tr>
                                <th>Nom</th>
                                <td>
                                    <input class="form-control" id="nomEmplacement_u" name="nomEmplacement_u" size="40px" required><b></b>
                                </td>
                            </tr>
                        </table>
                    </div>
...
<script src="../js/script/emplacements-script.js"></script>
