		 ...
		 <script>		 
			...
			$(function()
			{
				...
				$.ajax ({
					...
					success : function(response){ loadLibelle();  },
				...
				$(document).on('click', "#updateLibelle", function()
				{
					...
					$.ajax({
						...
						success : function(response){ loadLibelle(); alert(response.message); },
						error : function(resultat, statut, erreur){ },
					});
				});
				...
				$.ajax({
						...
						success : function(response){ loadEmplacement();  },
						error : function(resultat, statut, erreur){ },
					});
