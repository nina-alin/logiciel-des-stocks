...
class oAuthService
{
  private static $clientId = "83ae7713-c219-4e3a-a582-3d3133d6f412"; // 83ae7713-c219-4e3a-a582-3d3133d6f412
  private static $clientSecret = "h3qGX71sU_La~lAUa~C8-1LG2JJ4aOP-Qk"; // prod : "-9zgnKvVtI9K0xu-Ha-s30NbO56sn_j_14"
  ...
  public static function getAccessToken($redirectUri)
  {
    ...
    if (!is_null($current_token)) {
      ...
      if ($expiration < time()) {
        ...
        $expiration = time() + $new_tokens['expires_in'] + 3600;
