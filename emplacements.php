...
<head>
    ...
    <meta name="description" content="Page des emplacements de gestion">
    ...
    <script>
        ...
        $(document).on('click', '#btn-add', function(e) {
            var data = $("#templacements_form").serialize();
            $.ajax({
                data: {
                    type: 1,
                ...
                type: "post",
                url: "config/saveEmplacements.php",
...
<body>
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="active"><a href="/stocks/emplacements.php"><i class="fas fa-warehouse"></i>&nbsp;Emplacements</a></li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <br /><br />
                    <div class="col-1">
                        <button class="btn btn-warning" data-target="#myModalEmplacementsAdd" data-toggle="modal">
                    ...
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $result = mysqli_query($conn, "SELECT * FROM templacements ORDER BY nomEmplacement");
                                    while ($row = mysqli_fetch_array($result)) {
                                    ?>
                                        <tr templacementsPK="<?php echo $row["templacementsPK"]; ?>">
                                            <td><?php echo $row["nomEmplacement"]; ?></td>
                                            <td>
                                                <button class="update btn btn-primary" data-target="#myModalEmplacementsUpdate" data-toggle="modal" data-id="<?php echo $row["templacementsPK"]; ?>" data-nom="<?php echo $row["nomEmplacement"]; ?>">
                                                    <i class="fas fa-pen"></i>
                                                </button>&nbsp;
                                                <button class="delete btn btn-danger" data-target="#myModalEmplacementsDelete" data-toggle="modal" data-id="<?php echo $row["templacementsPK"]; ?>">
    ...
    <div class="modal fade" id="myModalEmplacementsAdd">
                ...
                <div class="modal-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                            <form id="templacements_form">
                                <tr>
                                    <th>Nom</th>
                                    <td>
                                        <input class="form-control" id="nomEmplacement" name="nomEmplacement" size="40px" value="" required><b></b>
                                    </td>
                                </tr>
                            </form>
                        </table>
    ...
    <div class="modal fade" id="myModalEmplacementsUpdate">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="update_form">
                    <!-- Modal Header -->
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Modifier un emplacement</h4>
                    </div>
                    <!-- Modal body -->
                    <div class="modal-body">
                        <div id="doubleU" style="display: none;"></div>
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                <tr>
                                    <th>Nom</th>
                                    <td>
                                        <input class="form-control" id="nomEmplacement_u" name="nomEmplacement_u" size="40px" value="" required><b></b>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <!-- Modal footer -->
                    <div class="modal-footer">
                        <input type="hidden" id="templacementsPK_u" name="templacementsPK_u" name="type">
    ...
    <div class="modal fade" id="myModalEmplacementsDelete">
        <div class="modal-dialog">
            <div class="modal-content">
                <form>
                    <!-- Modal Header -->
                    ...
                    <div class="modal-body">
                        <input type="hidden" id="templacementsPK_d" name="templacementsPK_d" class="form-control">
